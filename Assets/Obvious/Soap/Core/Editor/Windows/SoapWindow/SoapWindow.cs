    ...
    public class SoapWindow : EditorWindow
    {
        ...
        private void DrawSoapWizard()
        {
            EditorGUILayout.LabelField(
                ...
                "\n- Manage all SOAP Scriptable Objects in one place" +
                "\n- Filter all SOAP Scriptable Objects by tag" +
                "\n- Find all references of a SO (Scene and Assets)" +
                "\n- Add a SO to favorite" +
